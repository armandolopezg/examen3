						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Codigos Postales Estado de México Zona 5 50100</h2>
										</header>

									
										<div class="row">

										@foreach($postalescinco as $postalcinco)
											...
											<section class="box">
													...
													<header>
														<h3>{{$postalcinco['codigo']}}</h3>
														<h3>{{$postalcinco['pais']}}</h3>
														<h3>{{$postalcinco['lugar']}}</h3>
													</header>
