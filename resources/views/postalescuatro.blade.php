						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Codigos Postales Estado de México Zona 4 50020</h2>
										</header>

									
										<div class="row">

										@foreach($postalescuatro as $postalcuatro)
											...
											<section class="box">
													...
													<header>
														<h3>{{$postalcuatro['codigo']}}</h3>
														<h3>{{$postalcuatro['pais']}}</h3>
														<h3>{{$postalcuatro['lugar']}}</h3>
													</header>
