						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Codigos Postales Estado de México Zona 3 50010</h2>
										</header>

									
										<div class="row">

										@foreach($postalestres as $postaltres)
											...
											<section class="box">
													...
													<header>
														<h3>{{$postaltres['codigo']}}</h3>
                                                        <h3>{{$postaltres['pais']}}</h3>
                                                        <h3>{{$postaltres['lugar']}}</h3>
													</header>
